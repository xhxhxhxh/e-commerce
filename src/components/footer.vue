<template>
    <nav class="mui-bar mui-bar-tab">
        ...
        <router-link class="my-mui-tab-item" to="/shoppingCart">
            <span class="mui-icon mui-icon-extra mui-icon-extra-cart"><span class="mui-badge" id="endPosition">{{ $store.getters.cartTotalCount }}</span></span>
